...
from artists_data_chunk_4 import artists_data  # Ensure this file is in the same directory or adjust the path accordingly
...
try:
    fetch_all_artists_data('N_artists_data4.xlsx')
except Exception as e:
