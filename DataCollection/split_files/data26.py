...
from artists_data_chunk_26 import artists_data  # Ensure this file is in the same directory or adjust the path accordingly

# Authentication
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(client_id="36c9e626ae3440deb6a50345ff11234e",
                                                           client_secret="4731d436450848769e3eaa981cd0c51f"))
...
try:
    fetch_all_artists_data('N_artists_data26.xlsx')
except Exception as e:
