...
from artists_data_chunk_23 import artists_data  # Ensure this file is in the same directory or adjust the path accordingly

# Authentication
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(client_id="b2df128676c8491a8c6a78b41bfff0f4",
                                                           client_secret="37e2e2748f8340b6a691aff692726014"))
...
try:
    fetch_all_artists_data('N_artists_data23.xlsx')
except Exception as e:
